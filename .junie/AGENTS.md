...
2.  **Commit if Needed:** If uncommitted changes exist (and weren't made by you during this session's current turn), commit them immediately using the **Prompted** format specified in the guidelines.
